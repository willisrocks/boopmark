...
Icons are rasterized from `static/boopmark-logo.svg`; regenerate with `node scripts/e2e/chrome-icons.mjs` from the root. Chrome Web Store publishing is outside this development build.
